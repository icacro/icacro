...
const test = {
  ...
  createModal() {
    ...
    stepOne() {
      ...
      const ssn = ELM.copy('#CivicForm\\.CivicRegistrationNumber').attr('id','ssn').attr('placeholder','Personnummer').attr('name','ssn').attr('maxlength','13');
    ...
    stepTwo() {
      ...
      const cellphone = this.createRow('cellphone', 'Mobilnummer', 'phone', 'Ange ett svenskt mobilnummer', 'tel', 'mobile tel', cellphoneValue);
