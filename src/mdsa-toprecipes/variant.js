...
const test = {
  ...
  manipulateDom() {
    ...
    // (/^https:\/\/www.ica.se\/recept\/hamburgare\/$/.test(testURL))
    // (/^https:\/\/www.ica.se\/recept\/lax\/grillad\/$/.test(testURL))
    // (/^https:\/\/www.ica.se\/recept\/bal\/$/.test(testURL))
    // (/^https:\/\/www.ica.se\/recept\/vegan\/$/.test(testURL))
    // (/^https:\/\/www.ica.se\/recept\/nyttig\/middag\/$/.test(testURL))
    // (/^https:\/\/www.ica.se\/recept\/smoothie\/$/.test(testURL))
    // (/^https:\/\/www.ica.se\/recept\/smorgastarta\/$/.test(testURL))
    // (/^https:\/\/www.ica.se\/recept\/sallad\/$/.test(testURL))
