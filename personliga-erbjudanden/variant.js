...
(function($) {
  ...
  const couponId = 458288;
    ...
    const test = {
        ...
        addCoupon(container) {
            const self = this;
            const wrapper = self.create('personal-offer__recipe-and-coupon-l50-s100');
      ...
      loadCouponData() {
        return window.fetch(`/api/jsonhse/${couponId}`)
